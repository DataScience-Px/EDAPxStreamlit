...
dfkaj = pd.read_csv('https://github.com/DataScience-Px/EDAPxStreamlit/blob/main/dfclean.csv', sep=';', encoding='utf-8', engine='python', on_bad_lines='skip', names=cols, header=0, skiprows=1, skipfooter=1, index_col=False, parse_dates=['Start Date', 'Last Activity At'])
